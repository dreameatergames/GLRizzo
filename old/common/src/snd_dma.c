...
void S_Startup (void)
{
	...
	if (!fakedma)
	{
		...
		if (!rc)
		{
			...
			extern int desired_speed; // Manoel Kasimier
			if (desired_speed) // Manoel Kasimier
...
// anything coming from the view entity will allways be full volume
	if (ch->entnum == cl.viewentity || ch->dist_mult == 0) // Manoel Kasimier - edited
	{
...
// calculate stereo seperation and distance attenuation
	...
	if (shm->channels == 1 || !snd_stereo.value) // Manoel Kasimier - edited
	{
		rscale = 1.0;
		lscale = 1.0;
	}
