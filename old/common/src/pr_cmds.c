...
void PF_vectoangles (void)
{
	...
	else
	{
		...
		pitch = /*(int)*/ (atan2(value1[2], forward) * 180 / M_PI); // Manoel Kasimier - 16-bit angles - edited
		if (pitch < 0)
			pitch += 360;
	}
...
#else
cvar_t	sv_aim_h = {"sv_aim_h", "0.98", true}; // Manoel Kasimier - horizontal autoaim
#endif
cvar_t	sv_aim = {"sv_aim", "0.93", true}; // Manoel Kasimier - saving aim value
void PF_aim (void)
{
...
extern int current_protocol; // Manoel Kasimier - QC Alpha Scale Glow
