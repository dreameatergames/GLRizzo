...
//extern int				r_skydirect; // unused
//extern byte				*r_skysource; // Manoel Kasimier - smooth sky - removed
...
//void R_GenTile (msurface_t *psurf, void *pdest); // Manoel Kasimier - removed
...
extern float	skyshift; // Manoel Kasimier - skyboxes // Code taken from the ToChriS engine - Author: Vic (vic@quakesrc.org) (http://hkitchen.quakesrc.org/)
