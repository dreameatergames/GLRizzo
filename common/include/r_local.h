...
#define MAXALIASVERTS		2000	// TODO: tune this // 6000	Manoel Kasimier - (un)edited
...
#if	id386 // Manoel Kasimier - no 386 assembler, no MASM
void R_SurfacePatch (void);
#endif // Manoel Kasimier - no 386 assembler, no MASM
