...
cvar_t sv_makaqu = {"sv_makaqu", "0"}; // Manoel Kasimier
cvar_t sv_compatibility = {"sv_compatibility", "0"}; // Manoel Kasimier
...
void SV_Init (void)
{
	...
	Cvar_RegisterVariable (&sv_makaqu); // Manoel Kasimier
	Cvar_RegisterVariable (&sv_compatibility); // Manoel Kasimier
...
void SV_SendServerinfo (client_t *client)
{
	...
	if (sv_compatibility.value) // Manoel Kasimier
		MSG_WriteLong (&client->message, PROTOCOL_VERSION);
	else // Manoel Kasimier
		MSG_WriteLong (&client->message, PROTOCOL_VERSION-1); // Manoel Kasimier - 16-bit angles - edited
...
=============
*/
extern int current_protocol; // Manoel Kasimier
...
void SV_WriteClientdataToMessage (edict_t *ent, sizebuf_t *msg)
{
	...
	eval_t	*val;
#endif
	extern int current_protocol; // Manoel Kasimier - high values in the status bar
...
#endif
{
	edict_t		*ent;
	int			i;
	extern int current_protocol; // Manoel Kasimier - 16-bit angles
